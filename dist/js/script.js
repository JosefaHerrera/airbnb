	...
	$('#filtros').click(function() {
		...
		res.search_results.forEach(function(el){
			...
			$("#muestraDatos").append( '<div class="row">'+
											...
											'<img src="'+ el.listing.picture_url+'">'+
											' </div>'+	
										'</div>');
